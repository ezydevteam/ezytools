    ...
    <AiToolWrapper :remaining="remainingRequests">
        <div class="bg-white dark:bg-surface-800 p-6 rounded-2xl shadow-sm border border-surface-200 dark:border-surface-700">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Essay Topic or Thesis Statement</label>
                        <div class="relative">
                            <textarea 
                                v-model="inputText"
                                rows="3"
                                ...
                                placeholder="E.g. The impact of climate change on coastal economies."
                            ></textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-surface-500 mb-1">Academic Level</label>
                        ...
                        <div>
                            <label class="block text-xs font-medium text-surface-500 mb-1">Essay Type</label>
                            <select v-model="options.type" class="block w-full rounded-lg border-surface-300 dark:border-surface-600 bg-white dark:bg-surface-800 text-sm focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-surface-500 mb-1">Number of Paragraphs (Approx.)</label>
                        <select v-model="options.length" class="block w-full rounded-lg border-surface-300 dark:border-surface-600 bg-white dark:bg-surface-800 text-sm focus:ring-primary-500 focus:border-primary-500">
                            <option value="5-Paragraph">Standard 5-Paragraph</option>
                            <option value="Short (3-4 paragraphs)">Short (3-4 paragraphs)</option>
                            <option value="Long (6+ paragraphs)">Long (6+ paragraphs)</option>
                        </select>
                    </div>
                    ...
                    >
                        ...
                        <svg v-else class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" /></svg>
                        {{ isLoading ? 'Structuring Outline...' : 'Generate Outline' }}
                    </button>
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center">
                        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300">Essay Outline</label>
                    ...
                    <div class="relative h-full min-h-[400px]">
                        ...
                        <div v-else-if="isLoading" class="absolute inset-0 border border-surface-200 dark:border-surface-700 rounded-xl flex flex-col items-center justify-center bg-surface-50 dark:bg-surface-900/50">
                            ...
                            <p class="mt-4 text-surface-500 font-medium animate-pulse">Structuring points...</p>
                        </div>
