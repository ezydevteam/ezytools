    ...
    <AiToolWrapper :remaining="remainingRequests">
        <div class="bg-white dark:bg-surface-800 p-6 rounded-2xl shadow-sm border border-surface-200 dark:border-surface-700">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Original Message / Email</label>
                        <div class="relative">
                            <textarea 
                                v-model="inputText"
                                rows="6"
                                ...
                                placeholder="Paste the message you need to reply to here..."
                            ></textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-surface-500 mb-1">Your Stance / Goal</label>
                            <select v-model="options.stance" class="block w-full rounded-lg border-surface-300 dark:border-surface-600 bg-white dark:bg-surface-800 text-sm focus:ring-primary-500 focus:border-primary-500">
                                <option value="Agree / Accept">Agree / Accept</option>
                                <option value="Decline / Reject Politely">Decline / Reject Politely</option>
                                <option value="Say Thank You">Say Thank You</option>
                                <option value="Ask for More Info">Ask for More Information</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Any specific points to include? (Optional)</label>
                        <input v-model="options.key_points" type="text" class="block w-full rounded-lg border-surface-300 dark:border-surface-600 bg-surface-50 dark:bg-surface-900 text-surface-900 dark:text-white focus:ring-primary-500 focus:border-primary-500 text-sm" placeholder="E.g. I am available next Tuesday at 2 PM">
                    </div>
                    ...
                    >
                        ...
                        {{ isLoading ? 'Drafting Reply...' : 'Generate Reply' }}
                    </button>
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center">
                        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300">Generated Reply</label>
                    ...
                    <div class="relative h-full min-h-[300px]">
                        ...
                        <div v-else-if="isLoading" class="absolute inset-0 border border-surface-200 dark:border-surface-700 rounded-xl flex flex-col items-center justify-center bg-surface-50 dark:bg-surface-900/50">
                            ...
                            <p class="mt-4 text-surface-500 font-medium animate-pulse">Thinking of a reply...</p>
                        </div>
