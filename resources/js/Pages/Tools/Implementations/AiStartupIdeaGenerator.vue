    ...
    <AiToolWrapper :remaining="remainingRequests">
        <div class="bg-white dark:bg-surface-800 p-6 rounded-2xl shadow-sm border border-surface-200 dark:border-surface-700">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Industry or Problem Space</label>
                        <div class="relative">
                            <textarea 
                                v-model="inputText"
                                rows="3"
                                ...
                                placeholder="E.g. AI tools for productivity, sustainable packaging, or real estate tech."
                            ></textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-surface-500 mb-1">Business Model</label>
                            <select v-model="options.model" class="block w-full rounded-lg border-surface-300 dark:border-surface-600 bg-white dark:bg-surface-800 text-sm focus:ring-primary-500 focus:border-primary-500">
                                <option value="B2B SaaS">B2B SaaS</option>
                                <option value="B2C App">B2C Mobile App</option>
                        ...
                        <div>
                            <label class="block text-xs font-medium text-surface-500 mb-1">Number of Ideas</label>
                    ...
                    >
                        ...
                        {{ isLoading ? 'Brainstorming Ideas...' : 'Generate Ideas' }}
                    </button>
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center">
                        <label class="block text-sm font-medium text-surface-700 dark:text-surface-300">Startup Ideas</label>
                    ...
                    <div class="relative h-full min-h-[400px]">
                        ...
                        <div v-else-if="isLoading" class="absolute inset-0 border border-surface-200 dark:border-surface-700 rounded-xl flex flex-col items-center justify-center bg-surface-50 dark:bg-surface-900/50">
                            ...
                            <p class="mt-4 text-surface-500 font-medium animate-pulse">Generating ideas...</p>
                        </div>
